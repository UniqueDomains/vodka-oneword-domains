...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C747%20rows-8250df">
...
> **Important:** this repository is a **public 9,747-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,096 domains** on the canonical page below.

**Public extract:** 9,747 rows · **Live catalog:** 5,622,096 domains
...
- `vodka.csv` — public CSV extract (9,747 rows)
- `vodka.json` — public JSON extract (9,747 rows)
...
| wizard.vodka    | available | $38.98    | —             | 118            | 46     | 6      | namecheap               |
...
| ----------------------- | ------------------------------------------------ |
| 9,747-row public sample | 5,622,096 live domains                           |
...
> Unique Domains. *Available .VODKA One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
