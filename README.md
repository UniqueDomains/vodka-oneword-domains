# Available .VODKA One-Word Domains (5,622,096)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C748%20rows-8250df">
...
> **Important:** this repository is a **public 9,748-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,096 domains** on the canonical page below.

**Public extract:** 9,748 rows · **Live catalog:** 5,622,096 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/vodka?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/vodka?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./vodka.csv">CSV</a> / <a href="./vodka.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .VODKA search](https://unique.domains/domains/tld/vodka?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .VODKA search](https://unique.domains/domains/tld/vodka?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vodka_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./vodka.csv) or [Download JSON](./vodka.json)
...
- `vodka.csv` — public CSV extract (9,748 rows)
- `vodka.json` — public JSON extract (9,748 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,748-row public sample | 5,622,096 live domains                           |
...
| --------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------------- |
| live.vodka      | available | $38.98    | —             | 108            | 55     | 4      | namecheap               |
...
| gold.vodka      | resell    | —         | —             | 72             | 49     | 4      | GoDaddy.com, LLC        |
...
| lemon.vodka     | resell    | —         | —             | 66             | 40     | 5      | Porkbun                 |
| ace.vodka       | premium   | $250      | $45.99        | 88             | 57     | 3      | name.com                |
| event.vodka     | available | $38.98    | —             | 96             | 48     | 5      | namecheap               |
| garage.vodka    | resell    | —         | —             | 90             | 38     | 6      | GoDaddy.com, LLC        |
| business.vodka  | premium   | $52       | $31.20        | 100            | 53     | 8      | namecheap               |
| genius.vodka    | available | $38.98    | —             | 98             | 47     | 6      | namecheap               |
...
> Unique Domains. *Available .VODKA One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
